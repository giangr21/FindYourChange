...
export const MenuIcon = ({ color = 'currentColor', width = '26px', height = '18px' }: any): any => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 25.5 18">
