...
export const ArrowLeftRound = ({ color = 'currentColor', width = '18px', height = '14px' }: any): any => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 18 14.4">
            <path
