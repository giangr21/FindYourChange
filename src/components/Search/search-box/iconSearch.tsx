...
export const SearchIcon = ({ color = 'currentColor', width = '17px', height = '18px', ...props }): any => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 17.048 18" {...props}>
            <path
                id="Path_142"
                data-name="Path 142"
